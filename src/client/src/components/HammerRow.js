...
export class  HammerRow extends Component {
    ...
    render(){
      var grabbedBy = this.props.rowData[this.props.rowData.length - 1];
      var handledBy = this.props.rowData[this.props.rowData.length - 2];
      var stagedBy =  this.props.rowData[this.props.rowData.length - 3];
      ...
      return(<tr className={styles} ref={(row) => this.row = row}>{this.props.children}</tr>);
    }
  };