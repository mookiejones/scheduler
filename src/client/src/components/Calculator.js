    ...
    if (this.props.role === "load" || this.props.role === "watch") {
      if (this.props.rowData[this.props.rowData.length - 1] !== "##AVAILABLE##") {
        if (this.props.rowData[this.props.rowData.length - 2] !== "##AVAILABLE##") {
          return (
            <td>
              <i style={{ fontSize: "50px" }} className="fa fa-check-square-o" aria-hidden="true" />
            </td>
          );
        }
        return (
          <td>
            <i style={{ fontSize: "50px" }} className="fa fa-truck animate-flicker" id="" />
          </td>
        );
      }
      return <td />;
      ...
      return (
        <td className="action">
          <input
            ...
            style={{ width: "65px" }}
          />
          <i style={{ fontSize: "50px" }} className="fa fa-calculator" onClick={this.calcClick} />
        </td>
      );
    }
